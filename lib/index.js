(function(env){
  var previousProdPerfectRecorder = env.ProdPerfectRecorder || undefined;
  ...
  if (previousProdPerfectRecorder && typeof previousProdPerfectRecorder.resources === 'undefined') {
    Client.legacyVersion = previousProdPerfectRecorder;
  }
  ...
  Client.extendLibrary = function(target, source) {
    var previous = previousProdPerfectRecorder || source;
  ...
  Client.log = function(str){
    if (Client.debug && typeof console === 'object') {
      console.log('[ProdPerfectRecorder]', str);
    }
  };

  Client.noConflict = function(){
    if (typeof env.ProdPerfectRecorder !== 'undefined') {
      env.ProdPerfectRecorder = Client.legacyVersion || previousProdPerfectRecorder;
    }
    return Client;
  };
